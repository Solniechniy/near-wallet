...
const ClaimConfirmModal = ({ open, onClose, onConfirm, validator, amount, loading, title, disclaimer, label, sendingString, tokenMeta }) => {
    return (
        <Modal
        ...
        >
            <Container>
                ...
                <Textfit mode='single' max={40} className='amount'>
                    <FarmingBalanceDisplay amount={amount} className='stake-amount' tokenMeta={tokenMeta}/>
                </Textfit>
